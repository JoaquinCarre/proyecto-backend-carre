...
async function getAll() {
  try {
    ...
    logger.error(
      "No es posible obtener los productos de la base de datos ",
      err
    );
  }
}
...
async function addProduct(product) {
  try {
    ...
    logger.error(
      "No es posible crear la base de datos para los productos ",
      err
    );
  }
}
...
async function generateProduct(cant) {
  try {
    ...
    logger.error(
      "No es posible obtener productos Faker de la base de datos ",
      err
    );
  }
}
